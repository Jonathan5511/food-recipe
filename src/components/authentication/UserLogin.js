...
const UserLogin = () => {
  ...
  const onLoginHandler = (event) => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBqvEsXLQZLJwrlkBae_1qmWjufBRaimeI",
      {
        method: "POST",
        body: JSON.stringify({
          email: email,
  ...
  return (
    ...
    >
      <div className=" from-transparent via-transparent to-black/70"></div>
      ...
      <section className="flex items-center justify-center p-6 md:p-12 z-10">
        <div className="w-auto max-w-sm md:max-w-md lg:max-w-lg bg-white rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 p-6 md:p-8 space-y-6">
